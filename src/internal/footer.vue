        ...
        <div class="grid grid-cols-6 gap-4 p-8">
            ...
            <ul class="space-y-2">
                ...
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://www.discue.io/#how-it-works">How it works</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://www.discue.io/#use-cases">Use cases</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://www.discue.io/registration/create-account">Create Account</NavLink>
                </li>
            ...
            <ul class="space-y-2">
                ...
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://docs.discue.io/getting-started/">Getting started</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://docs.discue.io/api-overview/">API Overview</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://docs.discue.io/api-best-practices/">API Best Practices</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://docs.discue.io/api-reference/api-keys/get-all-api-keys.html">API Reference
                    </NavLink>
                </li>
            </ul>
            <ul class="space-y-2">
                ...
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://ui.discue.io/">Documentation</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://github.com/discue/ui-components">GitHub Repository</NavLink>
                </li>
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://www.npmjs.com/package/@discue/ui-components">npm Package</NavLink>
                </li>
            </ul>
            <ul class="space-y-2">
                ...
                <li class="text-md text-gray-800">
                    <NavLink :small="true"
                             :secondary="true"
                             href="https://www.discue.io/privacy">Privacy Policy</NavLink>
                </li>
                <li class="text-md text-gray-800">
                <NavLink :small="true"
                         :secondary="true"
                         href="https://www.discue.io/terms">Terms &amp; Conditions</NavLink>
            </li>
            <li>
                <NavLink :small="true"
                         :secondary="true"
                         href="https://www.discue.io/imprint">Imprint &amp; Legal Notice</NavLink>
            </li>
        </ul>
    </div>
